...
<motion.section
  id="vision"
  className="py-20 md:py-28 bg-gray-100 flex justify-center items-center"
...
>
  <div className="container mx-auto px-4">
    <motion.div
      className="max-w-3xl mx-auto bg-white shadow-2xl rounded-xl p-8 md:p-12 border border-gray-200 relative overflow-hidden"
    ...
    >
      ...
      {/* Animated Paragraph */}
      <motion.p
        className="text-lg md:text-xl leading-relaxed text-gray-700 text-center mt-6 px-2 md:px-6"
        initial={{ y: 20, opacity: 0 }}
        animate={{ y: 0, opacity: 1 }}
        transition={{ duration: 0.8, ease: "easeOut", delay: 0.5 }}
      >
        At <span className="font-semibold text-blue-600">Altersage</span>, we
        believe in fostering an environment of innovation, collaboration, and
        continuous growth. Our culture is built on the foundation of mutual
        respect, creative thinking, and a commitment to excellence in
...
<motion.section
  id="about"
  className="py-16 md:py-24 bg-gray-50 flex justify-center items-center"
  initial={{ opacity: 0, y: 50 }}
  whileInView={{ opacity: 1, y: 0 }}
  viewport={{ once: true }}
  transition={{ duration: 1, ease: "easeOut" }}
>
  <div className="container mx-auto px-4">
    ...
    {/* Mission Card */}
    <motion.div
      className="max-w-3xl mx-auto bg-white shadow-lg rounded-xl p-8 md:p-12 border border-gray-200 relative overflow-hidden"
      initial={{ scale: 0.9, opacity: 0 }}
      animate={{ scale: 1, opacity: 1 }}
      transition={{ duration: 0.8, ease: "easeOut" }}
      whileHover={{ scale: 1.02, boxShadow: "0px 10px 30px rgba(0,0,0,0.15)" }}
    >
      ...
      <motion.p
        ...
        transition={{ duration: 0.8, ease: "easeOut", delay: 0.5 }}
      >
        At <span className="font-semibold text-green-600">Altersage Innovations</span>, our
        mission is to revolutionize agriculture by developing intelligent
        robotic solutions that empower farmers with automation, precision, and
        efficiency. We strive to integrate AI-driven technology to optimize
        resource usage, reduce environmental impact, and ensure sustainable
    ...
    <div className="flex justify-center items-center">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12 max-w-6xl">
        {team.map((member, index) => (
          <motion.div
            key={index}
            className="flex flex-col items-center justify-center text-center bg-white shadow-lg rounded-lg overflow-hidden transform transition-all duration-300 hover:scale-105 hover:shadow-2xl"
            variants={fadeIn}
            whileHover={{ y: -8 }}
